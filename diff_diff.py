...
trace = go.Scatter(x=x_diff2, y=y_diff2, mode='lines', name='Differentiated 2nd')
data = [trace]
layout = go.Layout(title='Differentiated 2nd Plot')
fig = go.Figure(data=data, layout=layout)
pyo.plot(fig, filename='my_plot_diff2.html')
