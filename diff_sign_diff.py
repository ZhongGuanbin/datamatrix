...
# 将差分后的横坐标数组x_diff_diff和数组y_diff_sign_diff组成的关系图
trace_sign2 = go.Scatter(x=x_diff_diff, y=y_diff_sign_diff, mode='lines', name='Diff Sign Diff')
data_sign2 = [trace_sign2]
layout_sign2 = go.Layout(title='Diff Sign 2 Plot')
fig_sign2 = go.Figure(data=data_sign2, layout=layout_sign2)
pyo.plot(fig_sign2, filename='my_plot_diff_sign_diff.html')
