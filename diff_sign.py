...
# 将差分后的横坐标数组x_diff和符号数组y_diff_sign组成的关系图
trace_sign = go.Scatter(x=x_diff, y=y_diff_sign, mode='lines', name='Diff Sign')
data_sign = [trace_sign]
layout_sign = go.Layout(title='Diff Sign Plot')
fig_sign = go.Figure(data=data_sign, layout=layout_sign)
pyo.plot(fig_sign, filename='my_plot_diff_sign.html')
