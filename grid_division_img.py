...
image = cv2.imread(
    r"D:\SoftwareDevelopment\DevProject\Python\DataMatrix\DecodeDataMatrix\img_rebuild_binary\input\standard2.png")
...
# 保存画布
cv2.imwrite(r"D:\SoftwareDevelopment\DevProject\Python\DataMatrix\DecodeDataMatrix\grid\standard2.png",
            canvas)
